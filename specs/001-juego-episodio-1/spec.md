...
El guion completo ya existe en [guiones, §1](../../wiki/narrative/isla-de-los-acuerdos-guiones.md) y el contenido estructurado en [`content/episodes/ep01-saludo.json`](../../content/episodes/ep01-saludo.json). Esta spec no inventa contenido: lo ejecuta.
