...
El docente puede ser la única persona adulta a la que un niño le cuente algo, porque el agresor suele ser del entorno familiar ([evidencia §9](../../wiki/research/evidencia-psicologica-proteccion.md)). El panel existe para que ese docente llegue preparado y tenga el protocolo a un toque. El plan completo de 8 módulos está en [panel-facilitador](../../wiki/project/panel-facilitador.md); esta spec cubre solo lo que se construye ahora, sin backend.
