...
2. Busca en `wiki/` lo que ya se decidió sobre este tema. Esta spec no inventa producto: traduce a criterios verificables lo que la wiki y los guiones ya establecen. Si la wiki no lo cubre, dilo y pregunta antes de inventarlo.
